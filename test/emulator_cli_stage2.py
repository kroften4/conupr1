...
print(f">> testing \"python {root_dir}/main.py dummy/path/to/vfs {root_dir}/test/.sheshrc\" (correct path)")
test2_output = subprocess.check_output(
    ["python", f"{root_dir}/main.py", "dummy/path/to/vfs", f"{root_dir}/test/.sheshrc"]
)
print(test2_output.decode())
